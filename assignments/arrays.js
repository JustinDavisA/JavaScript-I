...
console.log(`Car ${this.id} is a ${this.car_year} ${this.car_make} ${this.car_model}` );
...
let lastCar = 0;
console.log(inventory[inventory.length].car_make);
console.log(inventory[inventory.length].car_model);
// ==== Challenge 3 ====
